...
void Phil_A(CondVar* ca, CondVar* cb, Lock* la, Lock* lb, char* ra, char* rb, char* name) {
...
void Phil_B(CondVar* ca, CondVar* cb, Lock* la, Lock* lb, char* ra, char* rb, char* name) {
...
void Phil_C(CondVar* ca, CondVar* cb, Lock* la, Lock* lb, char* ra, char* rb, char* name) {
  Take_R1(ca, la, ra, name,1);
  printf("%d %s start thinking\n",getpid(),name);
  sleep(0.5);
  printf("%d %s stop  thinking\n",getpid(),name);
